...
if __name__ == "__main__":
    ...
    # 主干网络的预训练权值
    '''
    这里有两次加载权值,第一种就是加载主干网络的预训练权值,第二种是加载人脸检测算法的预训练权值
    ...
    if model_path != '':
        ...
        #  update dic value and load new value
    ...
    if True:
        ...
        '''
        0.01的学习率对应batch_size为64的情况,小于64时学习率依次递减
        当b=8时, max(0.01/4,0.0005),0.05-------->0.0025
        '''
        ...
        # adam之所以需要两个动量参数是因为其有两种动量思想在其中,0.937我记得这是v5中调出来的
        optimizer.add_param_group({"params": pg1, "weight_decay": weight_decay})
        optimizer.add_param_group({"params": pg2})
        '''
        权重衰减一般不会对bn层中的参数使用,如果对其使用的话我记得是会造成过拟合(或欠拟合),具体忘了..
        '''
        ...
        # data-loader
        '''
        [b,3,H,W] [[n1,15],[n2,15].....[nb,15]]  x1y1x2y2  all normalize t0 (0,1) -1/1 valid/invalid key point
        4d matrix 
        list 
        '''
